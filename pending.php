                        ...
                        <div class="pd-billboard pd-category-header">
                            <div class="pd-l-plate-scale">
                                ...
                                <div class="pd-billboard-info">
                                    <h1 class="pd-billboard-header pd-util-compact-small-18"><a href="/">Tienda e-commerce</a></h1>
                                </div>
                            </div>
                        </div>
                    </div>
                                        ...
                                        <div class="as-producttile-title">
                                            <h3 class="as-producttile-name">
                                                <p class="as-producttile-tilelink">
                                                    <span data-ase-truncate="2" id="product-description">
                                                    	Aguarde! Seu pagamento teste esta em analise.<br><br>
<?php 
	echo 'ID do pagamento: '.htmlspecialchars($_GET['collection_id']).'<br>';
	// htmlspecialchars($_GET['collection_status']).'<br>';
	echo 'external_reference: '.htmlspecialchars($_GET['external_reference']).'<br>';
	echo 'payment_method_id: '.htmlspecialchars($_GET['payment_type']).'<br>';
	// htmlspecialchars($_GET['preference_id']).'<br>';
	// htmlspecialchars($_GET['site_id']).'<br>';
	echo 'Modo processamento: '.htmlspecialchars($_GET['processing_mode']).'<br>';
	// htmlspecialchars($_GET['merchant_account_id']).'<br>';
	// htmlspecialchars($_GET['payment_id']).'<br>';
	echo 'Status: '.htmlspecialchars($_GET['status']).'<br>';
	// htmlspecialchars($_GET['merchant_order_id']).'<br>';
?>
                                                    </span>
                                                </p>
                                            </h3>
