                                        ...
                                        <div class="as-producttile-title">
                                            <h3 class="as-producttile-name">
                                                <p class="as-producttile-tilelink">
                                                    <span data-ase-truncate="2" id="product-description"><?php echo $_POST['title'] ?></span>
                                                </p>
...
<?php
    ...
    // ...
    MercadoPago\SDK::setClientId(725762927);
    MercadoPago\SDK::setClientSecret('qatest65');
    ...
    //MercadoPago\SDK::setCollectorId("725736327");
